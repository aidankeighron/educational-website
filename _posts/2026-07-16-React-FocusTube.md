...
> Building for the web instead? The [FocusTube]({{ '/posts/FocusTube/' | relative_url }}) series builds the same project with NextJS.
{: .prompt-info }
