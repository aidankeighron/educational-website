...
> Task: Utilizing `getParticle` (it returns the particle at (row, col)) add a check in `moveParticle` to make sure a particle can not move on top of another particle:
{: .prompt-tip }
